...
from datetime import datetime #funcion de python
...
def prestar_libro(codigo, nombre_persona, fecha_prestamo_str, fecha_devolucion_str):
    ...
    fecha_p = datetime.strptime(fecha_prestamo_str, "%Y-%m-%d") #analiza fecha de prestamo
    ...
    if fecha_d < fecha_p:
        ...
        return   
    Prestamos.append({ #se agrega un nuevo prestamo a la lista
        "codigo_libro": codigo,
